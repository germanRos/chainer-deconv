...
from chainer.functions.loss import cross_entropy
from chainer.functions.loss import weighted_cross_entropy
...
from chainer.functions.math import sum_binary
...
from chainer.functions.pooling import max_pooling_2dIndices
...
cross_entropy = cross_entropy.cross_entropy
WeightedCrossEntropy = weighted_cross_entropy.WeightedCrossEntropy
weighted_cross_entropy = weighted_cross_entropy.weighted_cross_entropy
...
Sum = sum.Sum
sum = sum.sum
SumBinary = sum_binary.SumBinary
sum_binary = sum_binary.sum_binary
...
MaxPooling2DIndices = max_pooling_2dIndices.MaxPooling2DIndices
max_pooling_2dIndices = max_pooling_2dIndices.max_pooling_2dIndices
